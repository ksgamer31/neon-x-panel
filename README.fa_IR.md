...
<p align="center">
  <code>bash &lt;(curl -Ls https://raw.githubusercontent.com/ksgamer31/neon-x-panel/main/install.sh) v1.0.2</code>
</p>
...
وقتی `v1.0.2` به عنوان latest ثبت شد، بدون ورژن هم کار می‌کند:
