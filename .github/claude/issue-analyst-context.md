...
- Backend: Go 1.27, module `github.com/ksgamer31/neon-x-panel/v3`, Gin and GORM.
...
- Linux install: `bash <(curl -Ls https://raw.githubusercontent.com/ksgamer31/neon-x-panel/master/install.sh)`
...
- Docker image `ghcr.io/ksgamer31/neon-x-panel`; PostgreSQL profile
