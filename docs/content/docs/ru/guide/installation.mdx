...
[страницы релизов](https://github.com/ksgamer31/neon-x-panel/releases), распаковать его и
...
В каталоге [`deploy/`](https://github.com/ksgamer31/neon-x-panel/tree/main/deploy)
