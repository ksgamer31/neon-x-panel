...
[releases page](https://github.com/ksgamer31/neon-x-panel/releases), extract it, and run
...
The repo's [`deploy/`](https://github.com/ksgamer31/neon-x-panel/tree/main/deploy)
