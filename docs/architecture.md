...
> tree rather than a pinned release (Go module `github.com/ksgamer31/neon-x-panel/v3`).
>
...
- **Module path is `.../v3`.** Internal imports use `github.com/ksgamer31/neon-x-panel/v3/internal/...`.
