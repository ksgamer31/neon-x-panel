...
const (
	panelUpdaterURL      = "https://raw.githubusercontent.com/ksgamer31/neon-x-panel/main/update.sh"
...
func fetchPanelRelease(tag string) (*service.Release, error) {
	url := "https://api.github.com/repos/ksgamer31/neon-x-panel/releases/latest"
	if tag != "" {
		url = "https://api.github.com/repos/ksgamer31/neon-x-panel/releases/tags/" + tag
	}
